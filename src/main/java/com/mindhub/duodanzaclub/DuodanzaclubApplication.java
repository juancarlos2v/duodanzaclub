...
public class DuodanzaclubApplication {
	...
	public CommandLineRunner initData(UsuarioService usuarioService, AcademiaRepository academiaRepository,
		...
		return (args) -> {
			...
			Producto producto1 = productoRepository.save(new Producto("Zapatos de Salsa", "Zapatos de cuero", 12000.0, "Insert path", Estilos.BACHATA, "39", TipoProducto.CALZADOS, 5));
